...
class ShippingAddressViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        responses={
            200: openapi.Response(description="List of shipping addresses for the current user")
        }
    )
    ...
    @swagger_auto_schema(
        ...
        manual_parameters=[
            openapi.Parameter(
                'user_id', openapi.IN_QUERY, description="User UUID to find shipping addresses for", type=openapi.TYPE_STRING, required=True
            )
        ],
        responses={
            200: openapi.Response(description="List of shipping addresses for the user"),
