...
class PaymentViewSet(viewsets.ModelViewSet):
                            ...
                            items=openapi.Schema(
                                ...
                                properties={
                                    ...
                                    "payment_method": openapi.Schema(
                                        type=openapi.TYPE_STRING, enum=["chapa", "cod"]
                                    ),
            ...
            200: openapi.Response(
                ...
                schema=openapi.Schema(
                    ...
                    properties={
                        ...
                        "verification_data": openapi.Schema(
                            type=openapi.TYPE_OBJECT, nullable=True
                        ),
                        "webhook_data": openapi.Schema(
                            type=openapi.TYPE_OBJECT, nullable=True
                        ),
                        "created_at": openapi.Schema(
                        ...
                        "history": openapi.Schema(
                            ...
                            items=openapi.Schema(
                                ...
                                properties={
                                    ...
                                    "created_by_name": openapi.Schema(
                                        type=openapi.TYPE_STRING
                                    ),
                                    "created_at": openapi.Schema(
                                        type=openapi.TYPE_STRING,
    ...
    def initialize_chapa_payment(self, request):
        ...
        try:
            ...
            last_name = (
                "".join(part[0] for part in name_parts[1:])[
                    :35
                ]  # Take initials of remaining parts
                if len(name_parts) > 1
            ...
            return_url = (
                ...
                or f"{base_url}/payment-complete/"  # Default return URL
            )
        ...
        responses={
            200: openapi.Response(
                ...
                schema=openapi.Schema(
                    ...
                    properties={
                        "status": openapi.Schema(
                            type=openapi.TYPE_STRING, enum=["success", "failed"]
                        ),
                        "message": openapi.Schema(type=openapi.TYPE_STRING),
    ...
    @swagger_auto_schema(
        ...
        request_body=openapi.Schema(
            ...
            properties={
                "tx_ref": openapi.Schema(
                    type=openapi.TYPE_STRING, description="Transaction reference"
                ),
                "status": openapi.Schema(
                    type=openapi.TYPE_STRING,
                ...
                "transaction_id": openapi.Schema(
                    type=openapi.TYPE_STRING, description="Chapa transaction ID"
                ),
            },
        ),
        responses={
            200: openapi.Response(
                ...
                schema=openapi.Schema(
                    ...
                    properties={
                        "status": openapi.Schema(
                            type=openapi.TYPE_STRING, enum=["success"]
                        )
                    },
                ),
            ),
    ...
    def chapa_webhook(self, request):
        """Handle payment status updates from Chapa."""
        tx_ref = request.data.get("tx_ref")
