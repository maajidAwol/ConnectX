...
class Tenant(models.Model):
    ...
    business_registration_certificate = models.FileField(upload_to='business_registration_certificates/', null=True, blank=True)
    ...
    tax_registration_certificate = models.FileField(upload_to='tax_registration_certificates/', null=True, blank=True)
