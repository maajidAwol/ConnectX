...
// import 'package:shop/features/cart/presentation/pages/cart_screen.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  // Navigator.pushNamedAndRemoveUntil(context, cartScreenRoute, (route) => false);
                  Navigator.pushNamedAndRemoveUntil(
                    context, 
                    entryPointScreenRoute,
                    (route) => false,
                    arguments: 3 // Index 3 is for Cart based on EntryPoint widget
                  );
                },
