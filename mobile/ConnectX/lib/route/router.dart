...
import 'package:korecha/entry_point.dart';
import 'package:korecha/screens/checkout/views/checkout_screen.dart';
import 'package:korecha/features/product/presentation/pages/category_screen/category_screen.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case entryPointScreenRoute:
      return MaterialPageRoute(
        builder:
            (context) => EntryPoint(initialIndex: settings.arguments as int?),
      );
    case profileScreenRoute:
      return MaterialPageRoute(builder: (context) => const ProfilePage());
    case profileUpdateScreenRoute:
      return MaterialPageRoute(
